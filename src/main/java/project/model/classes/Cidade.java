...
@Audited //cria a tabela do histórico de alterações nos dados
@Entity //identifica que é uma tabela do banco de dados
@Table(name="cidade")
...
public class Cidade implements Serializable{
	...
	@IdentificaCampoPesquisa(descricaoCampo = "Estado", campoConsulta = "estado_est_nome")
	@Basic
	@ManyToOne
