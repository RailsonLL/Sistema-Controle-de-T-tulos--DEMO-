...
public class Titulo {
	...
	@IdentificaCampoPesquisa(descricaoCampo = "Usuário abertura", campoConsulta = "ent_codigoabertura", principal = 1)
	@Basic
	@ManyToOne
	...
	@IdentificaCampoPesquisa(descricaoCampo = "Usuário responsável", campoConsulta = "ent_codigo")
	@Basic
	@ManyToOne
