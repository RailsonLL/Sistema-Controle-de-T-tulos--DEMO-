...
public enum Permissao {
	...
	BAIRRO_ACESSAR("BAIRRO_ACESSAR", "Bairro - Acessar"), BAIRRO_NOVO("BAIRRO_NOVO", "Bairro - Acessar"),
	BAIRRO_EXCLUIR("BAIRRO_EXCLUIR", "Bairro - Acessar"), BAIRRO_EDITAR("BAIRRO_EDITAR", "Bairro - Acessar");
