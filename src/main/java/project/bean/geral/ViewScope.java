...
public class ViewScope implements Scope, Serializable{
	...
	public Object resolveContextualObject(String name) {
		FacesContext facesContext = FacesContext.getCurrentInstance();
		FacesRequestAttributes facesRequestAttibutes = new FacesRequestAttributes(facesContext);
	
		return facesRequestAttibutes.resolveReference(name);
	}

	//getViewRoot - Retorna o componente raiz que está associoado a esta solicitação(request)
